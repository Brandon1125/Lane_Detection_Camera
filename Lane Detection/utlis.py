...
#    lowerWhite = np.array([31, 0, 80])
#    upperWhite = np.array([132, 43, 205])

    lowerWhite = np.array([80, 0, 0])
    upperWhite = np.array([255, 160, 255])
#    upperWhite = np.array([255, 107, 255])
...
def getHistogram(img, display=False, minVal = 0.1, region = 4):
    ...
    if display:
        ...
        for x,intensity in enumerate(histValues):
            cv2.line(imgHist,(x,img.shape[0]),(x,img.shape[0]-(intensity//255//region)),(0,0,255),1)
